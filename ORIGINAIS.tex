...
ridículo bem contemporâneo, e o burguês de \index{Molière, Jean Baptiste}Molière é uma caricatura
...
\index{Balzac, Honoré de}Balzac, \emph{Eugênia Grandet}
\end{quote}
...
século \versal{XIX}, e um perfeito esquizo.). [Grifos Nossos] (\emph{Ibidem},
2004, p. 266).
\end{quote}
...
senhor da terra, mas escravo da máquina. \index{Musil, Robert}(\versal{MUSIL}, 2006, p, 58 [Grifos
Nossos])
\end{quote}
...
tivemos no século \versal{XIX}. (\versal{JÚNIOR}, 2011, p. 240)\index{Júnior, Caio Prado}
\end{quote}
...
invadisse todos os campos de atividade''. É o retrospecto de \index{Andrade, Oswald de}Oswald, em
1954. (1974, p. 11)
\end{quote}
...
preencheriam, e então, você será como um pedregulho na estepe. (\index{Beckett, Samuel}\versal{BECKETT},
2010a, p. 77-78)
\end{quote}
...
aumento.'', após apontar a luneta para o público. (\index{Beckett, Samuel}\versal{BECKETT}, 2010a, p.
69).
...
cabeça desaparece} [\ldots{}]) --- que venha para o bem. (\index{Beckett, Samuel}\versal{BECKETT},
2010b, p. 39)
\end{quote}
...
como ilusão do sujeito absoluto [\ldots{}]. (\index{Adorno, Theodor}\versal{ADORNO}, 1993, p.
252).
\end{quote}
