...
pedantes.'' \index{Robert, Paul}(\versal{ROBERT}, 1962, p. 541). Essa \emph{vida} \emph{preciosa} ``é
...
chatear quando se encenam a ridículas que as imitam mal.'' (\index{Molière, Jean Baptiste}\versal{MOLIÈRE},
1962, p. 220).
\end{quote}
...
lhe impõe, para não identificar"-se cegamente com isso.'' \index{Adorno, Theodor}(\versal{ADORNO}, 1995,
...
independência dos fatos uns em relação aos outros.'' (\index{Musil, Robert}\versal{MUSIL}, 1984, p.
...
inacabado nele e que pode crescer indefinidamente.'' \index{Roth, Marie-Louise}(\versal{ROTH}, 1981, p.
23).
...
pode pretender ser a vida delas (\index{Musil, Robert}Musil, 2006, p. 153).
\end{quote}
...
\emph{Mario de Andrade}, \emph{Macunaíma}\index{Andrade, Mário de}
\end{quote}
...
Como diz \index{Bosi, Alfredo}Bosi, no momento do modernismo, a Civilização mais requintada
...
coloca \index{Cross, Gary}Gary Cross em sua História dos Brinquedos [\ldots{}] Novos objetos
