...
H. Marcuse, L. Althusser e \index{Jameson, Fredric}F. Jameson estão entre os representantes mais
...
Adorno e Benjamin, Anselm Jappe\index{Jappe, Anselm} reflete sobre a relação estabelecida
...
Caio Prado\index{Júnior, Caio Prado} e Celso Furtado, a chave para entender o Brasil contemporâneo
...
da crítica. Não está implícito, sobretudo em Caio Prado\index{Júnior, Caio Prado} e Celso Furtado,
...
burguês. A fórmula ``ver com olhos livres'' (\versal{ANDRADE}, 1978, p. 9)
...
definitivamente a relação dos planos.'' (\versal{CÂNDIDO}, 1970, p. 85). No
...
\versal{JAPPE}\index{Jappe, Anselm}, 2006; \versal{KURZ}, 2010), no universo simbólico religioso, que foram
...
\versal{CANDIDO}, Antonio \& \versal{CASTELLO}, Aderaldo. \emph{Presença da literatura
...
\versal{GOTO}, Roberto. \emph{Malandragem revisitada}. Campinas: Pontes editora, 1988.
