...
cidades não tinham interesse em manter esse sistema. \index{Postone, Moishe}(\versal{POSTONE}, 2009, p.
308).
...
palácios"-Renascença dos mercadores italianos. \index{Gourevicht, Aron}(\versal{GOUREVICHT}, 1989, p.
...
latifúndios, sem uma unificação do mercado interior. \index{Rioux, Jean-Pierre}(\versal{RIOUX}, p. 117). O
...
superador e por isso também sua relação com a verdade. \index{Adorno, Theodor}(\versal{ADORNO} \&
\index{Horkheimer, Max}\versal{HORKHEIMER}, 1986, p. 13).
\end{quote}
...
buscá"-la mostrou"-se um instrumento desajeitado e frágil. \index{Webb, Eugène}(\versal{WEBB}, 2012, p.
28)
\end{quote}
...
absurda do homem se torna uma parábola do homem absurdo. \index{Anders, Günther}(\versal{ANDERS}, 2002,
p. 244).
\end{quote}
...
tornarem as qualidades transmitidas pelo dinheiro\footnote{``O que é
  ...
  pelo dinheiro''. \index{Marx, Karl}\versal{MARX}, K. \emph{\emph{Manuscritos
...
estudos brasileiros, nº 8, São Paulo, \versal{USP}, 1970, pp. 67-89.
