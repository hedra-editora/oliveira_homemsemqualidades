...
A crítica do valor revisitou de cabo a rado a herança de Marx e
...
Tentaremos expor aqui a temática desse devir"-sujeito"-dessubstancializado
...
Em \emph{O homem sem qualidades} (2006) de Robert Musil, no cruzamento
do século \versal{XIX} para o \versal{XX}, o dinheiro já é dinheiro moderno e mostra com
todo vapor sua potência na vida social. E o século \versal{XX} será o paroxismo
...
desenvolvimento e de uma atitude \emph{blasé} (\versal{SIMMEL}, 2009),
...
desenvolve em larga medida no século \versal{XX}. Esse século seria a
...
\versal{XXI}, quando, como nunca antes -- pode"-se dizê-lo -- a mercadoria está
...
O presente estudo pretende constituir"-se como uma reflexão sobre quatro
...
mentalidade mais próxima da forma burguesa no alvorecer do século \versal{XX},
...
Começaremos no século \versal{XI}, com o impulso que tiveram os mercadores, sem
...
Portanto, os sujeitos que veremos com Molière estão nesse
...
(\versal{SOARES} \& \versal{EWALD}, 2004, p. 08)
\end{quote}
...
oposto [\ldots{}] (\versal{BENJAMIN}, 2010, p. 118)
\end{quote}
...
Metodologicamente, um primeiro aspecto importante é refletir se de fato
...
Por isso, é para não naturalizar o social que nossa análise partirá das
...
mundo a fazer cálculos (\versal{ADORNO} \& \versal{HORKHEIMER}, 1986), não se implantou de
...
\versal{XII} e \versal{XIII}, que fez ganhar importância a figura do mercador (\versal{LE} \versal{GOFF},
...
essencial é o dinheiro'' (\versal{ROUSIAUD}, 1989, p. 169, Tradução Nossa). Ou
...
fundamentavam o nexo social (\versal{SIMMEL}, 2009, p. 287, Tradução Nossa).
...
capitais além de seus negócios (\versal{LE} \versal{GOFF}, 2011, p 24, Tradução Nossa). É
...
Gourevitch (1989) também atesta que é só no século \versal{XIV} e \versal{XV} que o
...
Além disso, o que se pretende dizer aqui é que o processo de
...
coincidência. Os séculos \versal{XI}, \versal{XII} e \versal{XIII} foram considerados também
...
uma visão negativa (\versal{WOLFF}, 1995, p. 20). O estranhamento que causavam na
...
ingleses\footnote{\begin{quote}
  ...
  40)
  \end{quote}} e franceses.''. (\versal{NEF}, 1954a, p. 52). E a própria vitória
...
\emph{Musil}, \emph{Testamento} \emph{II}, 1932.
...
burguesa, é possível reconhecer na sociedade a realidade}''\footnote{Cf.
  \versal{LUKÁCS}, G. \emph{\textbf{História e consciência de classe -- estudos
...
não"-humano''}\footnote{Cf. \versal{JAMENSON}, F. \emph{\textbf{Marxismo e forma --
...
homens\footnote{``[O]s trabalhos privados só atuam, de fato, como
  ...
  sociais entre coisas''. Cf. \versal{MARX}, K. \textbf{O capital: crítica da
...
tornarem as qualidades transmitidas pelo dinheiro\footnote{``O que é
  ...
  pelo dinheiro''. \versal{MARX}, K. \emph{\textbf{Manuscritos
...
qualidades do homem moderno poderia vir a criar\footnote{Este debate se
  ...
  \versal{DOSTOIÉVSKI}, F. \emph{\textbf{Os demônios}.} São Paulo, Editora 34,
...
\_\_\_\_\_\_. Sobre música popular. In: \versal{COHN}, Gabriel. \textbf{Theodor
Adorno: sociologia}. São Paulo: Ática, 1986. P. 68-71.

\versal{ADORNO}, Theodor W. \& \versal{HORKHEIMER}. \textbf{Dialética do esclarecimento:
...
\versal{ANDERS}, Gunter. \textbf{L'obsolescende de l'homme.} Paris: Éditions
Ivrea, Paris. 2002.
...
\versal{ANDRADE}, Oswald. \textbf{Do pau"-brasil à antropofagia e às utopias.} Rio
...
\emph{In:} \versal{BECKETT}, Samuel, \textbf{Fim de Partida}.Tradução de Fábio de
...
\versal{AQUINO}, Tomás de. \textbf{La Somme Théologique de Saint Thomas.} Paris:
Librairie éclésiastique et classique, 1855.

\versal{ARENDT}, Hannah. \textbf{Entre o passado e o futuro}. Tradução de Mauro
...
\versal{ASSARÉ}, Patativa do. \textbf{Antologia Poética.} Org. Gilmar de
Carvalho. Fortaleza: Edições Demócrito Rocha, 2008.

\versal{BARTHES}, Roland. \textbf{Écrits sur le théâtre}. Paris: Éditions du
Seuil, 2003.

\versal{BECKETT}, Samuel. \textbf{Fim de Partida}. Tradução de Fábio de Sousa.
...
\versal{BAUDRILLARD}, Jean. \textbf{O sistema dos objetos}. Tradução de
Zumira Tavares. 5.ed. São paulo~: Editora Perspectiva, 2004 .

\versal{BENJAMIN}, Walter. \textbf{Magia e técnica, arte e política}. In: Obras
...
\versal{BAUMAN}, Zygmunt. \textbf{Vida Para Consumo}. Tradução Carlos Albert
...
\versal{BOUVERESSE}, Jacques. \textbf{La voix de l'âme et les chemins de
l'esprit. Dix études sur Robert Musil.} Paris: Seuil, 2001.

\versal{BRAUDEL}, Fernand. \textbf{Civilisation matérielle, économie et
capitalisme -- \versal{XV}-\versal{XVIII} siècle.} (Vol. \versal{I} e \versal{III}). Paris: Armand Colin,
1979.

\versal{BRUCKNER}, Pascal. \textbf{A euforia perpétua. Ensaios sobre o dever de
felicidade}. Tradução de Rejane Janowitzer. Rio de Janeiro:
\versal{DIFEL}, 2002.

\versal{BRUYELLE}, Roland. \textbf{Les personages de la comédie de Molière.}
Paris: Rene Debresse éditeur, 1946.

\versal{BUCCI}, Eugênio, \versal{KEHL}, Maria Rita. \textbf{Videologias}. 1 Ed. 1.
...
\versal{CÂNDIDO}, Antônio. \textbf{Formação da Literatura brasileira.} Belo
...
estudos brasileiros, no 8, São Paulo, \versal{USP}, 1970, pp. 67-89.
...
\versal{COMETTI}, Jean Pierre. \textbf{Musil Philosophe. L'utopie de
l'essayisme.} Paris: Éditions du Seuil, 2001.

\versal{CROSBY}, Alfred. \textbf{A mensuração da realidade. A quantificação e a
sociedade ocidental 1250-1600.} Trad. Vera Ribeiro. São Paulo:
Unesp/Cambridge, 1999.

\versal{CUNHA}, Euclides da. \textbf{Os sertões.} São Paulo: Ateliê editorial,
2001.
...
\versal{DEBORD}, Guy. \textbf{A sociedade do espetáculo}. Tradução Estela
...
\versal{DELEUZE}, Gilles \& \versal{GUATARI} Félix. \textbf{O anti"-édipo. Capitalismo e
esquizofrenia 1.} Tradução de Joana Moraes e Manuel Maria. Lisboa:
Assírio \& Alvin, 2004.

\versal{DESCARTES}, René. \textbf{Discours de la méthode.} Paris: Flammarion,
1966

\versal{DUARTE}, Rodrigo. \textbf{Mímesis e Racionalidade}. São Paulo: Loyola,
1993.

\versal{DUBY}, Georges \& \versal{MANDROU}, Robert. \textbf{Histoire de la civilisations
française -- \versal{XVII}-\versal{XX} siècles.} Paris: Armand Colin, 1958.

\versal{DUFOUR}, Dany"-Robert. \textbf{O Divino mercado. A revolução cultural
...
\versal{DUMONT}, Louis. \textbf{Homo} \textbf{aequalis}. Trad. José Leonardo
Nascimento. Bauru: Edusc, 2000.

\versal{ECKERMANN}, Johann Peter. \textbf{Conversation de Goethe}. Trad. Émile
Délerot. Paris: Cherpentier, 1863. Tome premier.

\versal{ELIAS}, Norbert. \textbf{A sociedade dos indivíduos.} Trad. Vera Ribeiro.
Rio de Janeiro: Zahar, 1994.

\_\_\_\_\_\_\_. \textbf{O processo civilizador.} Trad. Ruy Jungmann. Rio
de Janeiro: Zahar, 1993.

\versal{ELIOT}, Thomas S. \textbf{Poemas.} São Paulo: Nova fronteira, 1981.

\versal{ESSLIN}, M. \textbf{O Teatro do Absurdo}. Tradução de Bárbara
Heliodora. Rio de Janeiro: Jorge Zahar , 1968.

\versal{FILHO}, Ciro Marcondes. \textbf{A linguagem da Sedução}. São Paulo:
Perspectiva, 1988.

\versal{FREYRE}, Gilberto. \textbf{Casa Grande e Senzala}. São Paulo: Global
editora, 2003.

\_\_\_\_\_\_. \textbf{Manifesto regionalista.} 7 ª ed. Recife: \versal{FUNDAJ},
ed. Massangana, 1996. p. 47-75. Acesso em 10 de dezembro de 2015:
\emph{http://www.ufrgs.br/cdrom/freyre/freyre.pdf}

\versal{FREUD}, Sigmund. \textbf{O Mal"-Estar na civilização}. Tradução de
...
\versal{FURTADO}. Celso. \textbf{Formação econômica do Brasil.} São Paulo:
...
\versal{GIMPEL}, Jean. \textbf{La révolution industrielle du Moyen Âge.} Paris:
Éditions du Seuil, 1975.

\versal{GOLDMANN}, Lucien. \textbf{Pour une sociologie du roman.} Paris:
Gallimard"-Collection Tel, 1986.

\versal{GOTO}, Roberto. Malandragem revisitada. Campinas: Pontes editora, 1988.

\versal{GOUREVICHT}, Aron. \textbf{Le marchand.} \emph{In: L'Homme médieval.}
Paris: Éditions du Seuil, 1989.

\versal{GRACIÁN}, Baltasar. \textbf{L'homme universel.} Trad. Joseph de
Courbeville. Paris: Éditions Ivrea, 1994.

\versal{GUICHARNAUD}, Jacques. \textbf{Molière, une aventure théâtrale.} Paris:
Gallimard, 1963.

\versal{GYORY}, Jean. \emph{Homo Austriacus. In:} \textbf{Cahier de L'herne.}
...
\versal{HEGEL}, G. W. F. \textbf{La raison dans l'histoire} [A razão na
história] Trad. Kostas P.. Paris: \emph{Éditions} 10/18, 2007.

\versal{HOBSBAWM}, Eric. \textbf{Da revolução industrial inglesa ao
imperialismo.} Tradução Donaldson Magalhães. 6ª ed. Rio de Janeiro:
Forense Universitária, 2014.

\_\_\_\_\_\_. \textbf{Era dos Extremos. O breve séc. \versal{XX}, 1914-1991.}
Trad. Marcos Santarrita. São Paulo: Companhia das Letras, 1995.

\versal{HOLANDA}, Sérgio Buarque. \textbf{Raízes do Brasil.} São Paulo: Companhia
das Letras, 2014.

\versal{HUIZINGA}, Johan. \textbf{O outono da Idade Média.} Trad. Francis Petra
Hansen. São Paulo: Cosac Naify, 2010.

\versal{JACOBY}, Russel. \textbf{Imagem Imperfeita: pensamento utópico para uma
época antiutópica}. Tradução de Carolina de Melo Bomfim Araújo.
Rio de Janeiro: Civilização Brasileira, 2007.

\versal{JAMESON}, Fredric. \textbf{Modernidade Singular.} Rio de Janeiro:
...
política no final do século \versal{XVIII}. In:} \textbf{História da vida privada
...
\versal{JÚNIOR}, Caio Prado. \textbf{A revolução brasileira. A questão agrária no
Brasil.} São Paulo: Companhia das Letras, 2014

\_\_\_\_\_\_. \textbf{Formação do Brasil contemporâneo.} São Paulo:
Companhia das Letras, 2011.

\versal{KANT}, I. \textbf{Textos seletos}. (Raimundo V. e Floriano F. Trad.).
Petrópolis: Vozes, 2005.

\versal{KEEGAN}, John. \textbf{Uma história da guerra.}Tradução Pedro Maia
Soares. São Paulo: Companhia das Letras, 2006.

\versal{KEHL}, Maria Rita. \textbf{18 crônicas e mais algumas.} São Paulo:
Boitempo, 2011.

\_\_\_\_\_\_. \textbf{O tempo e o cão. A atualidade das depressões.} São
Paulo: Boitempo, 2009.

\versal{KNOWLSON}, James. \textbf{Note sur les images visuelles de \emph{Oh les
beaux jours}.} In: Littérature. Paris: Armand Collin. Nº 16, 2012/3.

\versal{KRAUS}, Karl. \textbf{La littérature démolie.} Tradução Yves Kobry.
Paris: Payot, 1993.

\_\_\_\_\_\_ \textbf{Les derniers jours de l'humanité.} Trad. Jean"-Louis
Besson \& Henri Christophe. Marseille: Agone, 2003.

\versal{KURZ}, Robert. \textbf{Dinheiro sem valor. Linhas gerais para uma
...
\versal{LAPLANCHE} \& \versal{PONTALIS}. \textbf{Vocabulário de psicanálise.} Tradução
...
\versal{LEBRUN}, Jean"-Pierre. \textbf{Um mundo sem limite: ensaio para uma
crítica psicanalítica do social}. Tradução de Sandra Felgueiras .
Rio de Janeiro: Companhia de Freud editora, 2004.

\versal{LE GOFF}, Jacques. \textbf{Marchands et banquiers du Moyen Âge}. Paris:
...
\versal{LE RIDER}, Jacques. \textbf{A modernidade vienense e as crises de
identidade.} São Paulo: Civilização Brasileira, 1993.

\versal{LESSA}, Bia. \emph{Sem qualidade. In:} \versal{MUSIL}, Robert. \textbf{O homem sem
qualidades.} Rio de Janeiro: Nova Fronteira, 2006.

\versal{LIPOVETSKY}, Gilles. \textbf{L'ère du vide} [A era do vazio]. Paris:
Gallimard, 2008.

\versal{LITTRÉ}, Émille. \textbf{Dictionnaire de la langue française}. Paris:
Édition Pauvert, 1957. Tomo \versal{IV}.

\versal{LUCKÁCS}, Georg. \textbf{A teoria do romance.} Trad. José Marcos Mariani.
São Paulo: Duas Cidades/Editora 34, 2009.

\versal{MAAR}, Leo W.. Educação Crítica, Formação Cultural e Emancipação Política
na Escola de Frankfurt. In: \versal{PUCCI}, Bruno (Org.). \textbf{Teoria Crítica
...
moral. In:} \textbf{Filosofia moral britânica. Textos do século \versal{XVIII}.}
Trad. Álvaro Cabral. Campinas: editora unicamp, 2013.

\versal{MARCUSE}, Herbert. \textbf{Eros e Civilização}. Trad. De Álvaro Cabral.
...
\versal{MARFUZ}, Luiz. \textbf{Beckett e a implosão da cena}. São Paulo: editora
Perspectiva, 2014.

\versal{MARX}, Karl. \textbf{Grundrisse}. Tradução de Mário Duayer e Nélio
...
\versal{MARX}, Karl; \versal{ENGELS}, F. \textbf{A ideologia alemã.} Trad. Rubens Enderle,
Nélio Schneider e Luciano Cavini Martorano. São Paulo: Boitempo, 2007.

\versal{MELMAN}, Charles. \textbf{La nouvelle économie psychique: la façon de
...
\versal{MICHÉA}, Jean"-Claude. \textbf{L'enseignement de l'ignorance et ses
conditions modernes.} Paris: Climats 2006.

\versal{MICHELET}, Jules. \textbf{Histoire de France. Tome \versal{XV}ème.} Paris: Lacroix
\& C. Éditeurs, 1877.

\versal{MIRANDOLA}, Pico della. \textbf{Discurso sobre a dignidade do homem.}
Trad. Maria de Lurdes Sirgado. Lisboa: Edições 70, 2006.

\versal{MOLIÈRE}, Jean Baptiste. \textbf{Oeuvres complètes.} Paris: Bibliothèque
de la Pléiâde, 1962.
...
\versal{MUSIL}, Robert. \textbf{O homem sem qualidades}. Tradução de Lya Luft e
...
\versal{NEF}, John. \textbf{La guerre et le progrès humain.} Tradução Armand
...
\versal{PARKER}, Geoffrey. \textbf{La révolution militaire. La guerre et l'essor
de l'occident entre 1500 et 1800.} Paris: Gallimard"-Folio, 2013.

\versal{POSTONE}, Moishe. \textbf{Temps, travail et domination sociale.} Tradução
Luc Mercier e Olivier Galtier. Paris: Fayard, 2009.

\versal{PRADO}, Antônio Arnoni. Intinerário de uma falsa vanguarda. São Paulo:
Editora 34. 2010.

\versal{PRONKO}, Léonard. \textbf{Théâtre de l'avant"-garde. Beckett, Ionesco et
le théâtre expérimental em France.} Paris: Dénoël, 1963.

\versal{QUESNAY}, François. \textbf{Cereais.} Tradução Sara Albieri. São Paulo:
Nova Cultural, 1983.

\versal{RACINE}, Jean. \emph{Phèdre. In:} \textbf{Oeuvres complètes.} Paris:
...
\versal{RICCI}, Maria Teresa. \textbf{Du cortegiano au Discreto: l'homme accompli
chez Castiglione et Gracián.} Paris: Honoré Champion, 2009.

\versal{RIOUX}, Jean"-Pierre. \textbf{La révolution industrielle -- 1780-1880.}
Paris: Éditions du seuil, 1971.

\versal{ROBERT}, Marthe. \emph{Médiation. In:} \textbf{Cahier de L'herne.} Paris:
Éditions de L'herne, 1981.

\versal{ROBERT}, Paul. \textbf{Dictionnaire alphabétique et analogique de la
...
\versal{ROUANET}, Sérgio Paulo. \textbf{Teoria crítica e psicanálise}. Rio de
Janeiro: Tempo Brasileiro, 2001.

\versal{ROUSSIAUD}, Jacques. \textbf{Le citadin.} \emph{In: L'Homme médieval.}
Paris: Éditions du Seuil, 1989.

\versal{ROUX}, Edmonde Charles. \emph{Aspects de l'austrianité de Musil. In:}
\textbf{Cahier de L'herne.} Paris: Éditions de L'herne, 1981.

\versal{SARTRE}, Jean"-Paul. \textbf{Apresentação de Les Temps Modernes.} Revista
Praga. São Paulo: Editora Hucitec, 1999.

\versal{SCHOLZ}, Roswitha. \textbf{O Valor é o homem}. Trad. De José Marcos
Macêdo. In: \emph{Novos} \emph{estudos} -- \versal{CEBRAP}, nº. 45. Jul"-1996, p.
15-36. Disponível em
\emph{www.obeco.planetaclix.pt}. Acesso em julho 2013.

\versal{SCHWARZ}, Roberto. \textbf{Ao vencedor as batatas.} São Paulo: Duas
cidades; ed. 34, 2012
...
\versal{SEVERIANO}, Maria de Fátima. \textbf{Narcisismo e publicidade. Uma
análise psicossocial dos ideais de consumo na contemporaneidade}. 2. Ed.
São Paulo: Annablume, 2007.

\versal{SIMMEL}. Georg. \textbf{Philosophie de l'argent.} Trad. de Sabine Cornile
e Philippe Ivernel. 2ª edição, 4ª reimp. Paris: Presses Universitaires
de France, 2009.

\versal{SMITH}, Adam. \textbf{A riqueza das nações. Vol I.} Tradução Luiz João
...
\versal{SOARES}, Jorge C. \& \versal{EWALD}, Ariane. \textbf{Reflexões à sombra de
Adorno}. \emph{In: Revista Nomadas,} 2004. p. 1-12.

\versal{SOKEL}. Walter. \emph{Musil et l'existencialisme. In:} \textbf{Cahier de
...
\versal{TIEDEMANN}, Rolf. \emph{Introdução.}In: \textbf{Passages.} \versal{BENJAMIN}, W.
Paris: Éditions du Cerf, 1997.

\versal{TODOROV}, Tzvetan. \textbf{A literatura em perigo.} Tra. Caio Meira. Rio
...
\versal{WEBB}, Eugène. \textbf{As peças de Samuel Beckett.} Tradução de Pedro
Sette"-Câmara. São Paulo: Editora Biblioteca Teatral, 2012.

\versal{WEBER}, Max. \textbf{A ética protestante e o espírito do capitalismo.}
