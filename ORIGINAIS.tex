...
``ortodoxa'', os métodos de Marx e de \index{Engels, Friedrich}Engels, e às vezes também seus
...
Lefebvre e \index{Goldmann, Lucien}Lucien Goldmann, Theodor Adorno e \index{Benjamin, Walter}Walter Benjamin, E. Bloch e
H. Marcuse, L. Althusser e F. Jameson\index{Jameson, Fredric} estão entre os representantes mais
...
autores da literatura: Molière, Musil, Beckett e \index{Andrade, Mário de}Mário de Andrade. Este
...
Adorno e Benjamin\index{Benjamin, Walter}, Anselm Jappe\index{Jappe, Anselm} reflete sobre a relação estabelecida
...
de Hales, Albert Magno, \index{Aquino, Tomás de}Tomás de Aquino, \index{Brabant, Siger de}Siger de Brabant tentarão essa
...
Jacques Le Goff denomina essa passagem como sendo a passagem do
...
\versal{PARKER}, 1993; \versal{KEEGAN}, 2006)\index{Keegan, John}, quando a França parte pela Itália para
...
Portanto, seguindo Robert Kurz\index{Kurz, Robert}, não foi uma força criadora, como pensam
...
significa, como explica Ricci, que \index{Gracián, Baltasar}Gracián tenha um sentimento
...
e contínuo. Autores como Pico della Mirandola e \index{Gracián, Baltasar}Gracián estão a léguas
...
começo do século \versal{XVII} \index{Duby, Georges}Geoges Duby e Robert Mandrou:
...
do teatro de Molière, seu lado mágico \index{Guicharnaud, Jacques}(\versal{GUICHARNAUD}, 1963), a importância
...
Como relatam \index{Duby, Georges}Duby e Mandrou (1958, p. 44), as crônicas da época abundam
...
(\versal{MOLIÈRE}, 1893a, p. 5). Já o mestre de dança se sente enfastiado em ter
...
(\versal{MOLIÈRE}, 1893a, p. 9). Portanto, apesar do ridículo do personagem --
...
(\versal{MOLIÈRE}, 1893a, p. 14). E os mestres de música e dança o conduzem a uma
...
casa todas as quartas e quintas''. (\versal{MOLIÈRE}, 1893a, p. 23). Jourdain aceita
...
outras de Molière, escrita sob o modelo da comédia italiana (\versal{RAT}, 1962,
...
particular.'' (\versal{MARCUSE}, 1973, p. 136). Essa lógica formal
...
desenvolvida por \index{Benjamin, Walter}Benjamin (2006, p. 41) -- com base na frase de Michelet
...
\index{Benjamin, Walter}Benjamin não é a mesma de Marx. Este via o fetichismo na própria
...
Vejamos o trecho em que Weber analisa o puritano inglês \index{Baxter, Richard}Richard Baxter:
...
(\versal{ADORNO}, 2003, p. 57). O que importa ressaltar é o fato de que é
...
Se, como diz \index{Hanke, Michel}Hanke (2004), há na obra maior de Musil uma espécie de
...
Segundo \index{Cometti, Jean-Pierre}Jean"-Pierre Cometti (2001), Musil se divertiria em sua obra,
...
geralmente deram origem.'' (p. 76). Mas para \index{Cometti, Jean-Pierre}Cometti, a atitude de Musil
...
Evidentemente, seguindo \index{Cometti, Jean-Pierre}Cometti, a conclusão é que Musil não
...
inclusive usando o universo da técnica. Segundo \index{Cometti, Jean-Pierre}Cometti (2001), Musil
...
Embora, como diz \index{Cometti, Jean-Pierre}Cometti (2001), Musil não acreditasse ``na ciência no
...
possibilidades. Para \index{Cometti, Jean-Pierre}Cometti, em Musil a racionalização das sociedades
...
estritamente ao trabalho que resolvi fazer.}{Musil, Testamento \versal{II}, 1932.}
...
diz \index{Bouveresse, Jacques}Bouveresse, mesmo sendo \emph{sem} \emph{qualidades} definidas,
...
temíveis.''} (\emph{Ibidem}, p. 349)\index{Júnior, Caio Prado}. Pela pesquisa de Mott:
...
\emph{mais"-fetichismo,} ou \emph{duplo fetichismo}, (\versal{SEVERIANO},
...
baseados em tradições locais (\versal{MARX}, 1985; \index{Crosby, Alfred}\versal{CROSBY}, 1999, \versal{DUFOUR}\index{Dufour, Dany-Robert}, 2005;
...
quanto a Razão Instrumental (\versal{ADORNO} \& \versal{HORKHEIMER}), submetendo as
...
Mandeville, \index{Hume, David}David Hume e Adam Smith ---, era exatamente o caráter
...
É Lasch que também ressalta a lucidez de \index{Hume, David}Hume quanto ao perigo dessa
...
(\versal{MARX}). Mas o que acontece quando a produtividade aumenta em
...
(\versal{LIPOVETSKY}, 2008, p. 71-72).
\end{quote}
...
Segundo \index{Jameson, Fredric}Jameson, nas últimas peças de Beckett, o choque está
...
\index{Goldmann, Lucien}Lucien Goldmann, no esteio de Luckacs e \index{Girard, René}René Girard, levanta a hipótese
...
ruínas. Seguindo a alegoria no sentido de \index{Benjamin, Walter}Benjamin, o teatro de Beckett
...
Aqui, o objetivo é desenvolver uma reflexão em que as três peças de Beckett,
...
Portanto, leremos Beckett encarando o tempo presente como tempo de
...
mesmos nos formamos'' (\versal{SIMMEL}, 2009, p. 574)? É possível
...
a afirmação de \index{Andrade, Fábio de Souza}Fábio de Andrade segundo a qual a ficção de Beckett
...
aprisionados no tempo presente. No caso de \emph{Esperando Godot}, estão condenados à espera, não podem se mover (\versal{BECKETT}, 2005 p. 28-29):
...
consumo} \index{Bauman, Zygmunt}(\versal{BAUMAN}, 2008) e os sujeitos das peças de Beckett, ambos como
...
social que pode gestar frutos (\versal{SOARES}; \index{Ewald, Ariane}\versal{EWALD}, 2004, p. 04). Dessa forma,
...
os 4 (Molière, Musil, \index{Andrade, Mário de}Mário de Andrade e Beckett) escreveram em momentos
...
\versal{PRADO}, Antônio Arnoni. \emph{Intinerário de uma falsa vanguarda}. São Paulo:
Editora 34, 2010.
...
\versal{ROUSSIAUD}, Jacques. \emph{Le citadin. In}: \emph{L'Homme médieval.}
Paris: Éditions du Seuil, 1989.
